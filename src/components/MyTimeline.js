    ...
    <Paper elevation={3} sx={{ p: 2, bgcolor: 'background.paper', borderRadius: 2 }}>
      ...
      >
        <TimelineHeaders>
          ...
          <DateHeader unit="secondaryHeader" labelFormat="D" />
        </TimelineHeaders>
        <TimelineMarkers>
          <TodayMarker />
          {dependencyMarkers}
...
MyTimeline.propTypes = {
  tasks: PropTypes.arrayOf(
    PropTypes.shape({
      ...
      startDate: PropTypes.object, // Ahora PropTypes.object para objetos Moment
      endDate: PropTypes.object,   // Ahora PropTypes.object para objetos Moment
      Estado: PropTypes.string,
      etapa: PropTypes.string,
      Estimacion: PropTypes.string,
