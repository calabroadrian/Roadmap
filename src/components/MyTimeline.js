        ...
        <Tooltip
          title={
            <div style={{ textAlign: "left", fontSize: "0.85rem" }}>
              <div>
                <strong>Estimación:</strong> {item.estimacion || "N/A"}
              </div>
              <div>
              ...
              <div>
                <strong>Progreso:</strong> {item.progress || "N/A"}
              </div>
              <div>
                <strong>Dependencias:</strong> {item.dependencias || "N/A"}
              </div>
              <div>
                <strong>Bloqueos:</strong> {item.bloqueos || "N/A"}
              </div>
            </div>
          }
          arrow
